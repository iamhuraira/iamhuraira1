...
const Navbar = () => {
  ...
  return (
    <div
      ...
      className="fixed w-full h-20 shadow-xl z-[10000]"
      id="nav"
    >
      ...
      >
        <div
          className={
            nav
              ? 'fixed left-0 top-0  sm:w-[60%] md:w-[60%] h-screen bg-[#ecf0f3] md:p-10 p-6 ease-in duration-500'
              : 'fixed left-[-120%] top-0  sm:w-[60%] md:w-[60%] h-screen bg-[#ecf0f3] p-10  ease-in duration-500'
          }
        >
          <div>
